...
public class MainActivity extends Activity implements SearchView.OnQueryTextListener {
    ...
    private void setUpGridClickListener() {
        ...
        mainGrid.setOnItemClickListener(new OnItemClickListener() {
            ...
            @Override
            public void onItemClick(AdapterView<?> arg0, View clickedView, int position, long id) {
        ...
        public boolean onActionItemClicked(final ActionMode mode, MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.action_rename:
                    ...
                    rename_dialog.setPositiveButton("Rename", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                    ...
                    rename_dialog.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            mode.finish();
                        }
